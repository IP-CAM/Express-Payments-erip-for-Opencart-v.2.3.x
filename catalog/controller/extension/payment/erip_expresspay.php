...
class ControllerExtensionPaymentEripExpressPay extends Controller {
	public function index() {
		...
		$data['redirect'] = $this->url->link('extension/payment/erip_expresspay/send');
	...
	public function send() {
        ...
        try {
    		...
    		$this->redirect($this->url->link('extension/payment/erip_expresspay/fail'));
    	}
        ...
        if(isset($response->InvoiceNo))
        	$this->response->redirect($this->url->link('extension/payment/erip_expresspay/success'));
        else
        	$this->response->redirect($this->url->link('extension/payment/erip_expresspay/fail'));
	}
	...
	public function success() {
		...
		$this->response->setOutput($this->load->view('extension/payment/erip_expresspay_success.tpl', $data));
	}
	...
	public function fail() {
		...
		$this->response->setOutput($this->load->view('extension/payment/erip_expresspay_failure.tpl', $data));
	}
